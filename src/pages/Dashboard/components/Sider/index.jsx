...
const Sider = () => {
  ...
  return (
    <div
      className={`fixed! top-0 bottom-0 left-0 z-50 text-primary-text shadow-lg
      ...
      <nav className="flex flex-col gap-2 mt-4 px-2">
        {menuItems.map((item) => (
          ...
          >
            ...
            {!isSiderOpen && (
              <span
                className="absolute left-14 bg-black text-primary-text text-sm px-2 py-1 rounded-md
